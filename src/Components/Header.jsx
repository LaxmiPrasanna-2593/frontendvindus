      ...
      <nav className='navbar'>
        ...
        <div className={`menu ${menuOpen ? 'open' : ''}`}>
          <ul>
            ...
            <NavLink to='/case-studies' exact activeClassName='active' onClick={closeMenu}><li>Case Studies</li></NavLink>
        ...
        <div className='contact-me'>
            <NavLink to='/contact'><button className='contactbnt'>Contact US</button></NavLink>
        </div>

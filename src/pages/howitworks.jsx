...
const Accordion = ({ faq }) => {
  ...
  return (
    <div className="how-it-works__accordion-item">
      ...
      {isOpen && <div className="how-it-works__accordion-answer"><p>{faq.answer}</p></div>}
    </div>
  );
};
  ...
  return (
    <div className="how-it-works">
      ...
      <section className="how-it-works__services">
        <div className="how-it-works__service-card">
        ...
        <div className="how-it-works__service-card">
          <div className="how-it-works__icon-container how-it-works__icon-container--bg7">
            <FaRocket className="how-it-works__service-icon" />
          </div>
          <h2 className="how-it-works__service-title">Video Marketing</h2>
          <p className="how-it-works__service-description">
            <strong>Step 1:</strong> We develop a creative strategy and storyboard for your video content.<br/>
            <strong>Step 2:</strong> Our production team handles filming, editing, and post-production.<br/>
            <strong>Step 3:</strong> We distribute and promote your videos across various platforms to maximize reach.
          </p>
        </div>

        <div className="how-it-works__service-card">
          <div className="how-it-works__icon-container how-it-works__icon-container--bg8">
            <FaSeedling className="how-it-works__service-icon" />
          </div>
          <h2 className="how-it-works__service-title">Content Marketing</h2>
          <p className="how-it-works__service-description">
            <strong>Step 1:</strong> We create a content strategy tailored to your brand and audience.<br/>
            <strong>Step 2:</strong> Our team produces high-quality content, including blogs, articles, and social media posts.<br/>
            <strong>Step 3:</strong> We distribute and promote your content to engage your audience and drive traffic.
          </p>
        </div>
      </section>
      ...
      <section className="how-it-works__cta">
        ...
        <p className="how-it-works__cta-text">Get in touch with us today to discover how Vindus Environment Pvt. Ltd. can help your business grow digitally.</p>
        <button 
